    ...
    public function run(): void
    {
        $packages = [
            [
                ...
                'price' => 1900, 'currency' => 'MXN', 'price_type' => 'fixed',
                'direct_checkout' => true, 'requires_quote' => false, 'deposit_percentage' => 100,
            ...
            [
                ...
                'price' => 3500, 'currency' => 'MXN', 'price_type' => 'starting_at',
                'direct_checkout' => false, 'requires_quote' => true, 'deposit_percentage' => null,
                'featured' => false, 'is_featured' => false,
                'button_text' => 'Cotizar mi tienda',
